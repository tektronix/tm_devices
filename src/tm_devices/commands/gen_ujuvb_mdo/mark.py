...
Commands and Queries:
    ```
    - MARK {NEXT|PREVious}
    - MARK:CREATE {CH<x>|MATH|REF<x>|B<x>|REF<x>|DIGital|COLUMN|RF_AMPlitude|RF_FREQuency|RF_PHASe}
    - MARK:DELEte {CH<x>|MATH|REF<x>|B<x>|REF<x>|DIGital|COLUMN|SELECTED|ALL|RF_AMPlitude|RF_FREQuency|RF_PHASe}
    - MARK:FREE?
    - MARK:SAVEALL TOUSER
    - MARK:SELected:END?
    - MARK:SELected:FOCUS?
