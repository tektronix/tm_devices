...
Commands and Queries:
    ...
    - HISTogram:HISTogram<x>:MEASurement:RESUlts? {COUNt|HITS|MAX|MIN|PK2PK|MODE|MEAN|MEDian|PHITs|STDDev|ONESigma|TWOSigma|THRSigma,ALLAcqs|CURRentacq,MAXimum|MEAN|MINimum|PK2PK|POPUlation|STDDev}
