...
class Buffervar(BaseTSPCmd):
    ...
    def __init__(
        ...
        self._channels: dict[int, str | float] = DefaultDictDeviceCommunication(
        ...
        self._ptpseconds: dict[int, str | float] = DefaultDictDeviceCommunication(
    ...
    @property
    def channels(self) -> dict[int, str | float]:
    ...
    def collectchannels(self, value: str | float) -> None:
        """Access the ``bufferVar.collectchannels`` attribute.
    ...
    def collecttimestamps(self, value: str | float) -> None:
        """Access the ``bufferVar.collecttimestamps`` attribute.
    ...
    @property
    def ptpseconds(self) -> dict[int, str | float]:
