...
class CustomtableList(SCPICmdReadWithArguments):
    ...
    Description:
        - This command queries the list of custom result tables has been added. Only one result
          table is supported for CLR measurement.
...
class CustomtableDelete(SCPICmdWrite):
    ...
    Description:
        - This command deletes the custom result(s) table that was added. Only one result table is
          supported for CLR measurement.
...
class CustomtableAddnew(SCPICmdWrite):
    ...
    Description:
        - This command adds new custom results table. Only one result table is supported for CLR
          measurement.
...
class Customtable(SCPICmdRead):
    ...
    def delete(self) -> CustomtableDelete:
        ...
        Description:
            - This command deletes the custom result(s) table that was added. Only one result table
              is supported for CLR measurement.
