...
from .gen_e3e9uu_lpdmso.miscellaneous import Ddt
from .gen_e3e9uu_lpdmso.password import Password
from .gen_e3e9uu_lpdmso.pause import Pause
...
from .gen_e3e9uu_lpdmso.riddick_pi_manual import Lrn
...
from .gen_e3e9uu_lpdmso.scopeappreboot import Scopeappreboot
...
from .gen_e3e9uu_lpdmso.status_and_error import Ese, Opc, Psc, Rst
...
class MSO4Commands:
    ...
    Properties:
        ...
        - ``.scopeappreboot``: The ``SCOPEAppREBOOT`` command.
    ...
    def __init__(self, device: Optional[PIControl] = None) -> None:  # noqa: PLR0915
        ...
        self._scopeappreboot = Scopeappreboot(device)
    ...
    @property
    def scopeappreboot(self) -> Scopeappreboot:
        """Return the ``SCOPEAppREBOOT`` command.
