...
class TsplinkTriggerItem(ValidatedDynamicNumberCmd, BaseTSPCmd):
    ...
    """str: The number that is used for the trigger event."""
    ...
    def overrun(self) -> str:
        ...
        Usage:
            ...
            - Setting this property to a value will send the ``tsplink.trigger[N].overrun = value``
              command.
...
class Tsplink(BaseTSPCmd):
    ...
    def reset(self, expected_nodes: Optional[int] = None) -> str:
        ...
        Args:
            expected_nodes (optional): The number of nodes expected on the system.
    ...
    def writebit(self, n: str, data: int) -> None:
