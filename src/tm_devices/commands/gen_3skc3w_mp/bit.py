...
class Bit(BaseTSPCmd):
    ...
    def bitand(self, value1: str, value2: str) -> str:
        ...
        Args:
            value1: Operand for the logical AND operation; cannot be a negative number.
            value2: Operand for the logical AND operation; cannot be a negative number.
    ...
    def bitor(self, value1: str, value2: str) -> str:
        ...
        Args:
            value1: Operand for the logical OR operation; cannot be a negative number.
            value2: Operand for the logical OR operation; cannot be a negative number.
    ...
    def bitxor(self, value1: str, value2: str) -> str:
        ...
        Args:
            value1: Operand for the logical XOR operation; cannot be a negative number.
            value2: Operand for the logical XOR operation; cannot be a negative number.
    ...
    def clear(self, value: str, index: int) -> str:
        ...
        Args:
            ...
            index: One-based bit position within value to clear.
    ...
    def get(self, value: str, index: int) -> str:
        ...
        Args:
            value: Specified number.
            index: One-based bit position within value to get.
    ...
    def getfield(self, value: str, index: int, width: int) -> str:
        ...
        Args:
            value: Specified number.
            index: One-based bit position within value to get.
            width: The number of bits to include in the field.
    ...
    def set_(self, value: str, index: int) -> str:
        ...
        Args:
            value: Specified number.
            index: One-based bit position within value to set.
    ...
    def setfield(self, value: str, index: int, width: int, field_value: str) -> str:
        ...
        Args:
            value: Specified number.
            index: One-based bit position in value to set.
            width: The number of bits to include in the field.
    ...
    def test(self, value: str, index: int) -> str:
        ...
        Args:
            value: Specified number.
            index: One-based bit position within value to test.
    ...
    def toggle(self, value: str, index: int) -> str:
        ...
        Args:
            value: Specified number.
            index: One-based bit position within value to toggle.
