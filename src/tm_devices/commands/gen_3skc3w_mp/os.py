...
class Os(BaseTSPCmd):
    ...
    def clock(self) -> str:
        ...
        try:
            return self._device.query(  # type: ignore[union-attr]
                f"print({self._cmd_syntax}.clock())"
            )
        except AttributeError as error:
            msg = f"No TSPControl object was provided, unable to run the ``{self._cmd_syntax}.clock()`` function."  # noqa: E501
    ...
    def time(self, timespec: Optional[str] = None) -> str:
        ...
        Args:
            timespec (optional): The date and time (year, month, day, hour, minute, and second).
