...
Commands and Queries:
    ...
    - DPOJET:MEAS<x>:RJDJ:DETECTPLEN {ON|OFF|1|0}
    ...
    - DPOJET:MEAS<x>:RNDN:AUTODETECTpattern {ON|OFF|1|0}
    ...
    - DPOJET:MINBUJUI <NR3>
    - DPOJET:MINBUJUI?
    - DPOJET:NOISEENABLED {ON|OFF|1|0}
    - DPOJET:NUMMeas?
    - DPOJET:NUMPlot?
    ...
    - DPOJET:STATE?
    - DPOJET:TDCOMPensation {ON|OFF|1|0}
