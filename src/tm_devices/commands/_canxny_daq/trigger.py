...
class Trigger(BaseTSPCmd):
    ...
    Constants:
        - ``.EDGE_EITHER``: Detect either falling or rising-edge triggers as inputs on the EXTERNAL
          TRIGGER IN trigger line.
        - ``.EDGE_FALLING``: Detect falling-edge triggers as inputs on the EXTERNAL TRIGGER IN
          trigger line.
        - ``.EDGE_RISING``: Detect rising-edge triggers as inputs on the EXTERNAL TRIGGER IN trigger
          line.
        ...
        - ``.EVENT_TIMER1``: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until
          trigger timer 1 expires.
        - ``.EVENT_TIMER2``: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until
          trigger timer 2 expires.
        - ``.EVENT_TIMER3``: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until
          trigger timer 3 expires.
        - ``.EVENT_TIMER4``: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until
          trigger timer 4 expires.
        - ``.EVENT_TIMERN``: Trigger timer N (1 to 4) expired.
        - ``.EVENT_TSPLINKN``: Line edge detected on TSP-Link synchronization line N (1 to 3).
        - ``.LOGIC_NEGATIVE``: Assert a TTL-low pulse for output.
        - ``.LOGIC_POSITIVE``: Assert a TTL-high pulse for output.
    ...
    """str: Detect either falling or rising-edge triggers as inputs on the EXTERNAL TRIGGER IN trigger line."""  # noqa: E501
    EDGE_FALLING = "trigger.EDGE_FALLING"
    """str: Detect falling-edge triggers as inputs on the EXTERNAL TRIGGER IN trigger line."""
    EDGE_RISING = "trigger.EDGE_RISING"
    """str: Detect rising-edge triggers as inputs on the EXTERNAL TRIGGER IN trigger line."""
    ...
    """str: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until trigger timer 1 expires."""  # noqa: E501
    EVENT_TIMER2 = "trigger.EVENT_TIMER2"
    """str: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until trigger timer 2 expires."""  # noqa: E501
    EVENT_TIMER3 = "trigger.EVENT_TIMER3"
    """str: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until trigger timer 3 expires."""  # noqa: E501
    EVENT_TIMER4 = "trigger.EVENT_TIMER4"
    """str: Before asserting a trigger on the EXTERNAL TRIGGER OUT line, wait until trigger timer 4 expires."""  # noqa: E501
    ...
    """str: Assert a TTL-low pulse for output."""
    LOGIC_POSITIVE = "trigger.LOGIC_POSITIVE"
    """str: Assert a TTL-high pulse for output."""
