...
SIMULATED_DEVICE_LIST = (
    ...
    ("AFG", "AFG31022-HOSTNAME", None, None, None),
    ("AFG", "AFG31051-HOSTNAME", None, None, None),
    ("AFG", "AFG31052-HOSTNAME", None, None, None),
    ("AFG", "AFG31101-HOSTNAME", None, None, None),
    ("AFG", "AFG31102-HOSTNAME", None, None, None),
    ("AFG", "AFG31151-HOSTNAME", None, None, None),
    ("AFG", "AFG31152-HOSTNAME", None, None, None),
    ("AFG", "AFG31251-HOSTNAME", None, None, None),
    ("AFG", "AFG31252-HOSTNAME", None, None, None),
